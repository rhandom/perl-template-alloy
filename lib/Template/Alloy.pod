...
Template::Alloy manages its own stash of variables.  You can pass
a Template::Stash or Template::Stash::XS object, but Template::Alloy
will copy all of values out of the object into its own stash.  The
STASH option is only available when using the process method.
...
hash that contains the parsed tree.
  ...
  my $doc = $self->load_template($file)
      || $self->throw('undef', "Zero length content");
