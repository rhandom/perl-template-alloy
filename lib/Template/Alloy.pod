...
All of the various engines offer the same features - just using different
syntaxes and interfaces.
...
Allow module assimilation - allow for using Template::Alloy
without rewriting existing code.  Along the lines of:
