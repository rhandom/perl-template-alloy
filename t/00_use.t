...
ok(! eval "use Template::Alloy 'Text::Tmpl'; 1", "It can't be imported twice");

### override module namespace that isn't yet loaded
ok(! $INC{'HTML/Template.pm'},                       "HTML::Template isn't loaded");
ok(eval "use Template::Alloy 'HTML::Template'; 1",   "It can be imported ($@)");
ok($INC{'HTML/Template.pm'},                         "HTML::Template is now loaded");
ok(HTML::Template->isa('Template::Alloy'),           "HTML::Template is a Template::Alloy");
ok(! eval "use Template::Alloy 'HTML::Template'; 1", "It can't be imported twice");
...
ok(! eval{Template::Alloy->import('HTML::Template::Expr')}, "It can't be imported twice");
...
ok(! eval "use Template::Alloy 'Template'; 1", "It can't be imported twice");
